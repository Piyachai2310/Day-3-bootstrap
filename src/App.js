      ...
      <div className='container'>
        <header className='border-bottom lh-1 py-3'>
          <div className='row d-flex justify-content-between align-items-center'>
            ...
            <div className='col-4 d-flex justify-content-end align-items-center'>
              ...
              <a href='#' className='btn btn-sm btn-outline-secondary'>Sign up</a>
            </div>
          </div>
        </header>
        <div className='py-1 mb-3 border-bottom'>
          <nav className='nav nav-underline justify-content-between'>
            ...
            <a className='nav-item nav-link link-body-emphasis' href='#'>Pllitics</a>
      ...
      <main className='container'>
        <div className='p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary'>
          <div className='col-lg-6 px-0'>
            ...
            <p className='lead mb-0'>
              <a className='text-body-emphasis fw-bold' href='#'>Continue reading...</a>
            </p>
          </div>
        </div>
        ...
        <div className='row mb-2'>
          ...
          <div className='col-md-6'>
            <div className='row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative'>
              <div className='col p-4 d-flex flex-column position-static'>
                <strong className='text-primary-emphasis mb-2'>Design</strong>
                <h3 className='mb-0'>Post title</h3>
                <span className='text-muted'>Nov 11</span>
                <p>This is a wider card with supporting text below as a natural lead-in to additional content.</p>
                <a href='#' className='d-flex align-items-center icon-link icon-link-hover stretched-link'>
                  Continue reading
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708" />
                  </svg>
        ...
        <div className='row g-5'>
          ...
          <div className='col-md-4' >
            <div className='position-sticky' style={{position:"sticky" , zIndex:"1020" ,top:"0"}}>
